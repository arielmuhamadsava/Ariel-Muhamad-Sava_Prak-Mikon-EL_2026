...
void loop() {
  // Baca nilai mentah (Raw) ADC dari pin GPIO 34
  int rawADC = analogRead(POT_PIN);

  // Hitung nilai konversi Tegangan (Voltage) dan Hambatan (Resistance)
  ...
  // Tampilkan data ke Serial Monitor secara rapi
  ...
  // Tambahkan delay setiap siklus pembacaan (5 detik sekali)
  delay(5000);
}
